...
const About = () => {
    const text1 = "PyData is an educational program of NumFOCUS, a 501(c)(3) nonprofit organization in the United States. PyData provides a forum for the international community of users and developers of data analysis tools to share ideas and learn from each other. The global PyData network promotes discussion of best practices, new approaches, and emerging technologies for data management, processing, analytics, and visualization."
    
    const text2 = "PyData Lagos brings together data enthusiasts, researchers, and professionals to exchange knowledge and explore innovative techniques. Our community is passionate about using data science to address Africa’s unique challenges, while contributing to the global open-source ecosystem."
